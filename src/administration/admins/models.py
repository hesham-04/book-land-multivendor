    ...
    def fake(cls, total=10):
        ...
        for x in range(total):
            product = Product.objects.create(
                ...
                seller=SellerProfile.objects.order_by('?').first()  # Assign a random seller
            )
...
class OrderItem(models.Model):
    ...
    seller = models.ForeignKey(SellerProfile, on_delete=models.CASCADE, related_name="order_items")  # New field
