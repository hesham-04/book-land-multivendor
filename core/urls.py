...
urlpatterns += [
    ...
    path('', include('src.website.urls', namespace='website')),
    path('s/', include('src.administration.seller.urls', namespace='seller')), #USER DASH - SELLER
    path('c/', include('src.administration.client.urls', namespace='client')), #USER DASH - BUYER
]
